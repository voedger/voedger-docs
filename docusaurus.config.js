...
const config = {
  ...
  projectName: 'voedger-docs', // Usually your repo name.
  ...
  presets: [
    [
      ...
      ({
        docs: {
          path: 'docs', // Explicitly set docs folder path
          sidebarPath: require.resolve('./sidebars.js'),
          // Please change this to your repo.
          // Remove this to remove the "edit this page" links.
          editUrl:
            'https://github.com/voedger/voedger-docs/tree/main/',
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          {
            href: 'https://github.com/voedger/voedger-docs',
            label: 'GitHub',
            position: 'right',
          },
        ],
